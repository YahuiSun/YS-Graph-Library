...
std::vector<std::vector<std::string>> read_csv(std::string staynerd_dimacs_file) {
	...
	std::ifstream myfile(staynerd_dimacs_file); // open the file
	...
	{
		std::cout << "Unable to open file " << staynerd_dimacs_file << std::endl 
